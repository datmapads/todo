...
// Ke thua toan bo chuc nang CRUD cong viec cua Phien ban 1, bo sung:
//   - Dang ky / dang nhap / dang xuat tai khoan (mat khau bam SHA-256 + salt)
//   - Phien lam viec (session) qua cookie, luu trong bo nho server
//   - Moi tai khoan chi nhin thay va thao tac tren cong viec cua chinh minh
// =========================================================================
...
void LoadDbConfig()
{
    ...
    DB_NAME = dotenv::get("DB_NAME", "todo_db_v2");
...
int main()
{
    ...
    std::cout << "== PHIEN BAN 2 - DANG NHAP HE THONG ==\n";
